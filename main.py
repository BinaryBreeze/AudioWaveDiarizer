...
class CustomWarningDialog(QDialog):
    def __init__(self, message, parent=None):
        ...
        self.icon_label.setPixmap(
            QPixmap("assets/warning.png").scaled(80, 80,
                                                                                                          Qt.KeepAspectRatio))
...
class MainWindow(QWidget):
    ...
    def initUI(self):
        ...
        font_id = QFontDatabase.addApplicationFont("assets/MountainsofChristmas-Regular.ttf")
    ...
    def detect_languages(self, start_time=None, end_time=None):
        ...
        if start_time is not None and start_time > end_time:
            warning_dialog = CustomWarningDialog("Please enter Valid START TIME. The Start Time can't be more than the End Time")
            warning_dialog.exec_()
            return
